...
Service detection has been added to the side bar for easier access!

<img
  alt='Detected Services NavBar'
  src={useBaseUrl('img/merged-detected-services/detected-services-nav-bar.png')}
/>

## Create Services through the UI

effx detects your services from multiple sources and lets you know where all of the data we're getting is coming from.
...
After detecting your services, we use the different pieces of your service's metadata from your integrations and allow you to create it through the UI.
