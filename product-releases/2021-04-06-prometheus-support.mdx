...
Prometheus is a well know and supported open source monitoring solution.
Our integration surfaces alert data in the effx platform.
This provides insights into the changes and frequency of alerts across your teams.
