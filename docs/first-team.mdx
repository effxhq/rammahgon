...
Creating your first team is simple and can easily done by referencing our [full specification for Teams](/docs/teams-model).  In addition, we've provided [full example for an example-team](/docs/teams-model#yaml-reference) that can be modified or used as reference.
