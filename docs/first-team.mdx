...
Creating your first team is simple and can easily done by referencing our [full specification for Teams](/docs/teams-model.mdx).  In addition, we've provided [full example for an example-team](/docs/teams-model.mdx#yaml-reference) that can be modified or used as reference.
